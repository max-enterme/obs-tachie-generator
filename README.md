...
2. **② 立ち絵・演出プリセット**：再利用する見た目を作る。上段左＝プリセット一覧、上段右＝**画像**（「アップロード」⇄「画像URL」を切替＝排他）＋位置(left/bottom)・幅(width)＋発話演出（ぴょこぴょこ/枠・後光〈色・幅 指定可〉/点滅）＋静かな人を暗くする＋通話中は立ち絵を隠す、下段＝全幅プレビュー。「オプションを既定に戻す」ボタンあり。複数作れます。
