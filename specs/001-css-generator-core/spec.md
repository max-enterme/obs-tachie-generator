...
- **含む**:
  ...
  - **画像アップロード → data URI 埋め込み**(外部URL指定も可)。
  ...
  - **発話演出**(ぴょこぴょこ / 枠・後光〈**色指定可**〉/ 点滅)の on-off と強さ・色調整。
  - **静かな人を暗くする**(非発話の立ち絵を暗くし、話す人を目立たせる)。
  - **位置(left/bottom)・サイズ(width)調整**。
  - 出力: **per-person 個別（1人=1ブラウザソース・常時表示）**、ワンクリックコピー & ダウンロード。
- **含まない(v1)**:
...
- [ ] **per-person 個別ダウンロード**と**コピー**ができる
